...
<div className='features-grid-left'>
      ...
      <img src={img1}/>
        ...
        <div className='feature-text-container'>
            ...
            <p className='feature-desc'>Set the emotional tone with meaningful background music.</p>
        </div>
      </div>
      <div className='feature-card'>
      <img src={img2}/>
      ...
      <img src={img5}/>
        ...
        <div className='feature-text-container'>
            ...
            <p className='feature-desc'>Express your love, gratitude, and heartfelt tributes by messages</p>
        </div>
      </div>
      <div className='feature-card'>
      <img src={img6}/>
        ...
        <div className='feature-text-container'>
            ...
            <p className='feature-desc'>Share the extraordinary life stories of your beloved ones</p>
        </div>
      </div>
      </div>
      </div>
