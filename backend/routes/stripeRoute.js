...
const stripe = require('stripe')('sk_test_51NNKscJeKLCTKIlURrpWvy2YTxHqL24eoKHa6vIC2R40eDCqNpQQFjfNAMyzGb2MifQq4PI2ae7V42F6lIgbxkIU00jXHyV7tC');
...
router.post('/create-checkout-session', async (req, res) => {
    const session = await stripe.checkout.sessions.create({
      line_items: [
          {
            price: 'price_1NNLBZJeKLCTKIlUBPIA9NNm',
            quantity: 1,
          },
        ],
        mode: 'payment',
